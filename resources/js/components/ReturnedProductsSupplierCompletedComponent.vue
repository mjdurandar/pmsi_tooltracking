<template>
    <div class="p-3">
        <BreadCrumbComponent tab_title="Completed Returned Products"></BreadCrumbComponent>
        <div class="row mb-3">
            <div class="col-lg-2">
            ...
            <template #modalBody>
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <p>
                            Status : <b>{{this.dataValues.status}}</b>
                        </p>
                        <p>
                            Documentations : <b>{{this.dataValues.description}}</b>
                        </p>
                        <p>
                            User Information: 
                            <ul>
...
export default{
    ...
    data(){
        return{
                data : [],
                columns : ['brand_name', 'tool_name', 'serial_number', 'status' ,'action'],
                errors: [],
                serialNumber: '',
                selectedBrand: '',
                selectedTool: '',
    ...
    methods: {
        ...
        getData() {
            axios.get('returned-products-supplier-completed/showComplete').then(response => {
        ...
        filterData() {
            ...
            axios.post('returned-products-supplier-completed/completedFilterData', searchData)
                .then(response => {
                    this.data = response.data.data;
