            ...
            <template #modalBody>
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <p>
                            You canceled it At : <b>{{this.dataValues.canceled_at}}</b>
                        </p>
                        <p>
...
export default{
    ...
    methods: {
        ...
        getData() {
            axios.get('/canceled-order-user/canceledOrderUserShow').then(response => {
        ...
        filterData() {
            ...
            axios.post('/canceled-order-user/canceledFilterData', searchData)
                .then(response => {
                    this.data = response.data.data;
