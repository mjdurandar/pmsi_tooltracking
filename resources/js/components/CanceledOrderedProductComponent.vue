<template>
    <div class="p-3">
        <BreadCrumbComponent tab_title="Canceled Orders"></BreadCrumbComponent>
        <div class="row mb-3">
            <div class="col-lg-2">
            ...
            <template #modalBody>
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <p>
                            This Product is canceled because of: <b>{{ this.dataValues.reason }}</b>
                        </p>
                    </div>
                </div>
            </template>
...
export default{
    ...
    data(){
        return{
                ...
                selectedBrand : '',
                selectedTool : '',
                columns : ['brand_name', 'tool_name', 'canceled_at' ,'action'],
                errors: [],
                options : {
                    headings : {
                        brand_name : 'Brand',
    ...
    methods: {
        getData() {
            axios.get('canceled-ordered-products/canceledShow').then(response => {
